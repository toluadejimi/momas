                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    @else
                                                        ...
                                                        <div class="col-xl-6 my-2 col-sm-12">
                                                            ...
                                                            <input type="number" disabled value="{{$tarrif_amount}}"
                                                                   class="form-control mb-3" name="tarrif_amount"
                                                                   required>
                                                        </div>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        @else
                                                            ...
                                                            <input required name="vatAmount"
                                                                   value="{{number_format($vatAmount,2)}}" hidden="">

                                                            <input required name="costOfUnit"
                                                                   value="{{number_format($costOfUnit,2)}}" hidden="">
                                                    </div>
                                                ...
                                                <td>
                                                    @if($data->status == 2)
                                                        <a href="recepit?trx_id={{$data->trx_id}}"
                                                           onclick="return confirmreprint();" class="btn btn-primary">Reprint</a>
                                                        <script>
