                            ...
                            <div class="card-body">
                                <div class="widget-first">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <p class="mb-0 text-dark fs-15">Total Withdrawal</p>
                                    </div>

                                    <div class="d-flex align-items-center">
                                        <h3 class="mb-0 fs-24 text-black me-2">₦{{number_format($total_withdrawal)}}</h3>
                                        <a href="withdraw-funds" class="btn btn-primary">Withdraw Funds</a>
                            ...
                            <div class="card-body">
                                <div class="widget-first">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <p class="mb-0 text-dark fs-15">Total Funded</p>
                                    </div>
