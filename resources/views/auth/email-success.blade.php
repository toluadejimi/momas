                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                    ...
                                    <div class="auth-title-section mb-3 text-center">
                                        <h3 class="text-dark fs-20 fw-medium mb-2">Email Sent</h3>
                                        <p class="text-dark text-capitalize fs-14 mb-0">We have sent a reset password to your email, Kindly login to your email and follow the instruction</p>
                                    </div>
                                    ...
                                    <div class="pt-0">
                                        <a href="/" id="loginBtn"  class="btn btn-primary w-100">Go back to Login</a>
                                    </div>
                                </div>
