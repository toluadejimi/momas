                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                    ...
                                    <div class="auth-title-section mb-3 text-center">
                                        ...
                                        <p class="text-dark text-capitalize fs-14 mb-0">Enter Secured Password</p>
                                    </div>
                                    ...
                                    <div class="pt-0">
                                        <form id="loginForm" action="resetpasswordnow"  method="post"  class="my-4">
                                            @csrf
                                            <div class="form-group mb-3">
                                                <input  name="email"  value="{{$email}}" hidden>
                                                <input  name="code"  value="{{$code}}" hidden>
                                                <input class="form-control" name="password" type="password" required placeholder="Password Confirmation" >

                                            </div>

                                            <div class="form-group mb-3">
                                                <input class="form-control" name="confirm_password" type="password" required placeholder="Password Confirmation" >
