            ...
            <div class="d-flex justify-content-between">
                ...
                <ul class="list-unstyled topnav-menu mb-0 d-flex align-items-center">
                    ...
                    <li class="dropdown notification-list topbar-dropdown">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="analytics.html#" role="button" aria-haspopup="false" aria-expanded="false">
                            ...
                            <div class="dropdown-item noti-title">
                                <h5 class="m-0">
                                            <span class="float-end">
                                                <a href="analytics.html" class="text-dark">
                            ...
                            <div class="noti-scroll" data-simplebar>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item text-muted link-primary active">
                                    <div class="notify-icon">
                                        <img src="{{url('')}}/public/assets/ass/images/users/user-12.jpg" class="img-fluid rounded-circle" alt="" />
                                    </div>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item text-muted link-primary">
                                    <div class="notify-icon">
                                        <img src="{{url('')}}/public/assets/ass/images/users/user-2.jpg" class="img-fluid rounded-circle" alt="" />
                                    </div>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item text-muted link-primary">
                                    <div class="notify-icon">
                                        <img src="{{url('')}}/public/assets/ass/images/users/user-3.jpg" class="img-fluid rounded-circle" alt="" />
                                    </div>
                                    <div class="notify-content">
                                        <div class="d-flex align-items-center justify-content-between">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item text-muted link-primary">
                                    <div class="notify-icon">
                                        <img src="{{url('')}}/public/assets/ass/images/users/user-8.jpg" class="img-fluid rounded-circle" alt="" />
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item text-muted link-primary">
                                    <div class="notify-icon">
                                        <img src="{{url('')}}/public/assets/ass/images/users/user-5.jpg" class="img-fluid rounded-circle" alt="" />
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item text-muted link-primary">
                                    <div class="notify-icon">
                                        <img src="{{url('')}}/public/assets/ass/images/users/user-6.jpg" class="img-fluid rounded-circle" alt="" />
                                    </div>
                                    <div class="notify-content">
                                        <div class="d-flex align-items-center justify-content-between">
                    ...
                    <li class="dropdown notification-list topbar-dropdown">
                        <a class="nav-link dropdown-toggle nav-user me-0" data-bs-toggle="dropdown" href="analytics.html#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="{{url('')}}/public/assets/ass/images/users/user-5.jpg" alt="user-image" class="rounded-circle">
        ...
        <div class="h-100" data-simplebar>
            ...
            <div id="sidebar-menu">
                ...
                <ul id="side-menu">
                    ...
                    <li>
                        <a href="analytics.html#sidebarDashboards" data-bs-toggle="collapse">
                    ...
                    <li>
                        <a href="analytics.html#sidebarAuth" data-bs-toggle="collapse">
                    ...
                    <li>
                        <a href="analytics.html#sidebarError" data-bs-toggle="collapse">
                    ...
                    <li>
                        <a href="analytics.html#sidebarExpages" data-bs-toggle="collapse">
                    ...
                    <li>
                        <a href="analytics.html#sidebarBaseui" data-bs-toggle="collapse">
                    ...
                    <li>
                        <a href="analytics.html#sidebarAdvancedUI" data-bs-toggle="collapse">
                    ...
                    <li>
                        <a href="analytics.html#sidebarIcons" data-bs-toggle="collapse">
                    ...
                    <li>
                        <a href="analytics.html#sidebarForms" data-bs-toggle="collapse">
                    ...
                    <li>
                        <a href="analytics.html#sidebarTables" data-bs-toggle="collapse">
                    ...
                    <li>
                        <a href="analytics.html#sidebarCharts" data-bs-toggle="collapse">
                    ...
                    <li>
                        <a href="analytics.html#sidebarMaps" data-bs-toggle="collapse">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-auto">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="analytics.html#">Today</a>
                                            <a class="dropdown-item" href="analytics.html#">This Week</a>
                                            <a class="dropdown-item" href="analytics.html#">Last Week</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12 col-xl-4">
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body">
                                ...
                                <p class="m-0 fs-14 fst-italic text-muted mb-0 mt-2 pt-1">Last data updated - 13min ago <a href="analytics.html#!" class="link-danger ms-1 "><i class="align-middle mdi mdi-refresh"></i></a></p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-auto">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="analytics.html#">Created</a>
                                            <a class="dropdown-item" href="analytics.html#">Converted</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col fs-13 text-muted text-center">
                        &copy; <script>document.write(new Date().getFullYear())</script> - Made with <span class="mdi mdi-heart text-danger"></span> by <a href="analytics.html#!" class="text-reset fw-semibold">Zoyothemes</a>
                    </div>
                </div>
            </div>
        </footer>
...
<script src="https://apexcharts.com/samples/{{url('')}}/public/assets/ass/stock-prices.js"></script>
